                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.packages.store') }}" id="packageForm">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="speed" class="block mt-1 w-full" type="text" name="speed" :value="old('speed')" required placeholder="Contoh: 10 Mbps, 20/10 Mbps" />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="type" name="type" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                ...
                                <option value="fup" {{ old('type') == 'fup' ? 'selected' : '' }}>FUP (Fair Usage Policy)</option>
                                <option value="quota" {{ old('type') == 'quota' ? 'selected' : '' }}>Quota</option>
                            </select>
                        ...
                        <div id="fupConfig" class="mb-4 p-4 bg-gray-50 rounded-md" style="display: none;">
                            ...
                            <div class="mb-3">
                                ...
                                <x-text-input id="fup_threshold" class="block mt-1 w-full" type="number" name="fup_threshold" :value="old('fup_threshold')" min="0" placeholder="Contoh: 100" />
                            ...
                            <div>
                                ...
                                <x-text-input id="fup_speed" class="block mt-1 w-full" type="text" name="fup_speed" :value="old('fup_speed')" placeholder="Contoh: 2 Mbps" />
